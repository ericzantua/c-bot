...
│   └── src/
│       ├── App.jsx        top nav (Z-Bot·Products·Settings) + 🌐 language selector + view switch; owns product list. Brand (🛒 C-Bot) removed; first tab is labelled "Z-Bot"
